...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0D0D0D] border-t border-[#1E1E1E] mt-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 px-6 py-12">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <span className="text-sm text-[#8A8A8A]">Lunes a Sábado · 18 a 22hs</span>
            <span className="text-sm text-[#8A8A8A]">Castro Barros 1547 esq. Congreso</span>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          <h4
            style={{ fontFamily: 'var(--font-display)' }}
            className="text-sm font-bold tracking-widest text-[#F0EFEB] uppercase">
            Categorías
          </h4>
          <ul className="flex flex-col gap-2 list-none m-0 p-0">
            {categorias.map((cat) => (
              <li key={cat.href}>
                <Link
                  href={cat.href}
                  className="text-sm text-[#8A8A8A] hover:text-[#F5A623] transition-colors duration-200">
                  {cat.label}
                </Link>
              </li>
            ))}
        ...
        <div className="flex flex-col gap-4">
          ...
          <a
            ...
            className={[
              ...
              "text-[#8A8A8A] hover:text-[#25D366] transition-colors duration-200"
            ].join(' ')}>
      ...
      {/* BARRA INFERIOR */}
      <div className="border-t border-[#1E1E1E] px-6 py-4 flex flex-col md:flex-row items-center justify-between gap-2">
